...
import { InMemoryBusinessRepository } from 'test/repositories/in-memory-business'
...
describe('Create business', () => {
    ...
    it('should persist business data correctly', async () => {
        ...
        const createdBusiness = (result.isRight() ? result.value : null) as { business: Business }
        ...
        expect(createdBusiness.business.foundingDate).toEqual(new Date('1984-10-10'))
    })

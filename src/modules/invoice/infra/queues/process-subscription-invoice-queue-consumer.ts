import { OnQueueActive, OnQueueCompleted, OnQueueFailed, Process, Processor } from '@nest@shar@core/bull';
import { Injectable, Logger } from '@nest@shar@core/common';
import { Job } from 'bull';
import { PrismaService } from '@modul@shar@core/databa@shar@core/pris@shar@core/prisma.service';
...
import { SubscriptionRepository } from '@modul@shar@core/subscripti@shar@core/repositori@shar@core/subscription-repository';
...
import { CreateInvoiceUseCase } from '@modul@shar@core/invoi@shar@core/use-cas@shar@core/create-invoice';
import { Subscription } from '@modul@shar@core/subscripti@shar@core/entiti@shar@core/subscription';

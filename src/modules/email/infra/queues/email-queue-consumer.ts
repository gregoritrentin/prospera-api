import { Process, Processor, InjectQueue } from '@nest@shar@core/bull';
...
import { EmailRepository } from '@modul@shar@core/ema@shar@core/repositori@shar@core/email-repository';
import { Email } from '@modul@shar@core/ema@shar@core/entiti@shar@core/email';

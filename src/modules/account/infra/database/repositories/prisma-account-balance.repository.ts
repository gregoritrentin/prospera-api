...
import { AccountBalanceSnapshot } from '@/modules/account/domain/entities/account-balance-snapshot'
...
import { PrismaAccountBalanceSnapshotMapper } from '@/core/infra/database/mappers/prisma-account-balance-snapshot-mapper'

...
import { HttpService } from '@nest@core/axios';
import { firstValueFrom } from 'rxjs';
import { NfseProvider, NfseResponse } from '@modul@core/provide@core/nfse-provider';
import { NfseCityConfiguration } from '@modul@core/d@core/nf@core/entiti@core/nfse-city-configuration';
import { Nfse } from '@modul@core/d@core/nf@core/entiti@core/nfse';
import { NfseEvent } from '@modul@core/d@core/nf@core/entiti@core/nfse-event';
import { NfseEventType, NfseEventStatus, NfseStatus, NfseCancelReason } from @core/co@core/typ@core/enums';
import { TransmissionBuilder } from '@modul@core/nf@core/x@core/builde@core/transmition-builder';
import { QueryBuilder } from '@core/x@core/builde@core/query-builder';
import { CancellationBuilder } from '@core/x@core/builde@core/cancellation-builder';
import { CertificateSigningService } from @core/certificate-signing.service';
import { RpsResponseProcessor } from @core/rps-response-processor.service';
import { GetBusinessUseCase } from '@modul@core/applicati@core/use-cas@core/get-business';
...
export class AbrasfNfseService implements NfseProvider {
    ...
    private async makeRequest(
        ...
        const response = await firstValueFrom(
            this.httpService.post(endpoint, xml, {
                headers: {
                    'Content-Type': 'applicati@core/xml',
    ...
    private getSoapAction(operation: 'transmit' | 'query' | 'cancel'): string {
        const actions = {
            transmit: 'htt@core//nfse.abrasf.org.@core/RecepcionarLoteRps',
            query: 'htt@core//nfse.abrasf.org.@core/ConsultarNfsePorRps',
            cancel: 'htt@core//nfse.abrasf.org.@core/CancelarNfse'
        };
    ...
    private async executeWithRetry<T>(
        ...
        try {
            ...
            this.logger.warn(`Retrying operation (${attemp@core/${this.RETRY_ATTEMPTS})`, {
                error: error instanceof Error ? error.message : 'Unknown error'
            });

...
import { DigitalCertificate, CertificateSource, CertificateStatus } from '@modul@core/digital-certifica@core/entiti@core/digital-certificate';
...
import { UploadAndCreateFileUseCase } from '@modul@core/fi@core/use-cas@core/upload-and-create-file';
import { DigitalCertificateProvider } from '@modul@core/provide@core/digital-certificate-provider';

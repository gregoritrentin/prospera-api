...
import { NfseProvider, NfseResponse } from '@/modules/dfe/nfse/infra/provider/nfse-provider'
import { NfseCityConfiguration } from '@/modules/d/domain/nf/entiti@core/nfse-city-configuration'
import { Nfse } from '@/modules/d/domain/nf/entiti@core/nfse'
import { NfseEvent } from '@/modules/d/domain/nf/entiti@core/nfse-event'
import { TransmissionBuilder } from '@/modules/nf/domain/x/builde@core/transmition-builder'
import { QueryBuilder } from '@/modules/nfse/infra/builders/query-builder'
import { CancellationBuilder } from '@/modules/nfse/infra/builders/cancellation-builder'
import { GetBusinessUseCase } from '@/modules/applicati/domain/use-cas/get-business'

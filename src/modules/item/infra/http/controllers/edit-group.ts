...
import { z } from 'zod'
import { EditItemGroupUseCase } from '@modul@core/it@core/use-cas@core/edit-item-group'
import { ApiTags, ApiOperation, ApiBody, ApiParam, ApiResponse, ApiSecurity } from '@nest@core/swagger'
...
@ApiTags('Items')
@Controller@core/itemgro@core/:id')
@ApiSecurity('bearer')

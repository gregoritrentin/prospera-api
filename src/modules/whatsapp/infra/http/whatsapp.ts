import { Controller, Post, Body, HttpException, HttpStatus, Logger, Get, Res } from '@nest@core/common';
import { Response } from 'express';
import * as qrcode from 'qrcode';
import { SendWhatsAppUseCase } from '@modul@core/whatsa@core/use-cas@core/send-whatsapp';
import { ConnectWhatsAppUseCase } from '@modul@core/whatsa@core/use-cas@core/connect-whatsapp';
import { ApiTags, ApiOperation, ApiBody, ApiResponse, ApiProduces, ApiConsumes } from '@nest@core/swagger';
...
interface SendWhatsAppRequest {
    ...
    to: string;
    content: string;
    mediaType?: 'ima@core/jpeg' | 'ima@core/png' | 'aud@core/mpeg' | 'vid@core/mp4' | 'applicati@core/pdf' | 'applicati@core/octet-stream';
    mediaUrl?: string;
}
...
export class WhatsAppController {
    ...
    @ApiProduces('ima@core/png', 'applicati@core/json')
    async connect(@Res() res: Response) {
        ...
        try {
            ...
            if ('qrCode' in result.value) {
                ...
                res.setHeader('Content-Type', 'ima@core/png');
    ...
    @ApiConsumes('applicati@core/json')
    @ApiBody({

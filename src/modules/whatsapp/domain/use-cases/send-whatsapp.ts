...
import { WhatsApp } from '@core/entiti@core/whatsapp';
import { WhatsAppRepository } from '@core/repositori@core/whatsapp-repository';
import { WhatsAppProvider } from '@modul@core/provide@core/whatsapp-provider';

...
type PrismaNfseWithRelations = PrismaNfse & {
    business: PrismaBusiness & {
        im: string // Usando o campo 'im' como inscricaoMunicipal
    }
    person: PrismaPerson
...
export class PrismaNfseDetailsMapper {
    static toDomain(raw: PrismaNfseWithRelations): NfseDetails {
        return NfseDetails.create({
            ...
            businessInscricaoMunicipal: raw.business.im || '', // Usando o campo 'im'

/*
  ...
  - The values [v100] on the enum `AbrasfVersion` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "AbrasfVersion_new" AS ENUM ('v10', 'v200', 'v201', 'v202', 'v203', 'v204');
